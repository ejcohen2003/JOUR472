...
**Task** Run the following code and describe the dataframe it outputs. **It gives a dataset of 999 different Cardin press releases**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **It removes repeated words (case-sensitive)**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **It lists all the different words Cardin used**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **I don't find it extremely interesting because very few of the words are that telling about anything/they lack substance.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **I think it's more interesting because it's the actual subjects he's talking about instead of simple/less interesting words.**
...
**Task** Run the following code and describe the results. **It gives the top 10 words from each year and there is some overlap**
...
**Task** Run the following code and describe the results. **It gives a similar list of words but they are placed together**
...
**Task** Run the following code and describe the results. **Gives a different list of two-word phrases that likely associate with some of Cardin's priorities.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **They mostly seem like correct associations**
