...
**Task** Run the following code and describe the dataframe it outputs. **It shows us the changes in population, GDP, and per peupil spending in 2021 along with if the state voted for Trump or Biden in 2020.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **A slight positive relationship**
...
**Task** Run the following code. Describe the plot. What do you see? **It's pretty even with a slight negative slope**
...
**Task** Run the following code. Describe the model output. What do you see? **The p-value is extremely low and that this is likely not correlated**
...
**Task** Run the following code. Describe the model output. What do you see? **The p value is very very high while the r value is extremely low.**
...
**Task** Run the following code. Describe the table. What do you see? **It takes the data from task 2 but instead of doing it by state, it groups all the states together that voted for each candidate**
...
**Task** Run the following code. Describe the output. What do you see? **It shows that the difference in means is substantial but the t value is -1.828 and the p value is 0.07411**
...
**Task** Run the following code. Describe the output. What do you see? **An extremely high t value and a low p value, which would mean there's a significant pattern/trend here.**
