...
```{r, echo=FALSE}
knitr::include_graphics("datawrapper1.png")
```
...
md_gov_county <- md_gov_county |> mutate(total_votes = cox + moore + lashar + wallace + harding, moore_pct = moore/(total_votes)*100)
...
<https://www.datawrapper.de/_/4BCVA/>
