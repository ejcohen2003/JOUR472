...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **It loads the data and adds new columns with the month and arranges the total calls with the highest at the top**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It's a bar chart with the calls by month and is sorted so the months with the most calls are further along the X axis, but doesn't seem to be labeled very well**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It switched the X and Y axis'**
...
**Task** Run the following code. What do you think this does? **Makes the ggplot an image**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Calls by each individual date ranging from 2/06/22-1/31/23**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A line plot but it looks like it's a little too condensed because the value goes up and down pretty rapidly on a very steep incline/decline**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It changes the labels for the dates and they become overly jumbled**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It changes the orientation of the date labels and while it definitely isn't perfect, it's a much better solution than the one in task 9**
