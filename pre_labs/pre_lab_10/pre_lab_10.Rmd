...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **The regions that are not all the way south, but almost like the second closest layer to the bottom have the highest foreclosure rates according to the map**
