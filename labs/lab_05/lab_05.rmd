...
A1. There aren't any days without a call and we know this because there are 366 rows (it's not 365 because it double counts feb 6 in both 2022 and 2023) which means that there were calls on every day in that span of a year. However, because it starts in February, we can't confirm for sure if there was a day without a call in January, so we don't know for sure. There are multiple days with 23 calls which was the most.
...
A2. **There is no significant trend on calls per day of the week as it is somewhat even across the board. If anything, the most noticeable pattern is that there are slightly more calls on the weekends.**
...
A3. The amount of calls from 4540 silver spring rd is shocking
...
A4. What I'd be most interested in is how this years data compares to previous years and what's gone into that trend.
